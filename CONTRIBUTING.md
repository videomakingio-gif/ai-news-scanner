...
- Use the [bug report template](https://github.com/backpropagation6/ai-news-scanner/issues/new?template=bug_report.md)
- Include your Python version, OS, and the error traceback
- If possible, share your `config.yaml` (remove API keys!)

### Suggesting Features

- Use the [feature request template](https://github.com/backpropagation6/ai-news-scanner/issues/new?template=feature_request.md)
